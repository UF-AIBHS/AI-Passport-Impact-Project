...
module.exports = function(eleventyConfig) {
  ...
  // Rewrites root-relative href/src (e.g. "/styles/style.css") to include
  // --pathprefix at build time, so the site works under a GitHub Pages
  // project subpath (https://<org>.github.io/<repo>/) without a custom domain.
