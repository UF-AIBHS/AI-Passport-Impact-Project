...
**ML4LLM anchor:** Combines techniques from [Project 1](project-01-tokenizer-jargon.md), [Project 3](project-03-topic-drift-chat.md), [Project 7](project-07-attention-symptoms.md), and [Project 6](project-06-layer-diagnosis.md) — see the [book's table of contents](https://github.com/saurabhr/ML4LLM_book)
