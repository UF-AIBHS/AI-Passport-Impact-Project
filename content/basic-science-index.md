...
| 3 | [Topic drift in patient–doctor chat](basic-science-project-03-topic-drift-chat.md) | Ch.3 · proj9 | MedDialog (English) | Where does turn-to-turn embedding similarity drop, marking the symptom-gathering → diagnosis pivot? |
...
| 7 | [Attention to symptom keywords](basic-science-project-07-attention-symptoms.md) | Ch.6 · proj35 | HealthCareMagic-100k | Does generation-time attention concentrate on clinically salient symptom words? |
