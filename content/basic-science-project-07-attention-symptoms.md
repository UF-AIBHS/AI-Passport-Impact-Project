...
**Context:** Built on [HealthCareMagic-100k](https://huggingface.co/datasets/lavita/ChatDoctor-HealthCareMagic-100k) patient messages describing symptoms (Hugging Face) — single patient/doctor pairs are enough here since the analysis is per-message, not turn-to-turn (unlike Project 3, which needs the multi-turn MedDialog set), anchored to ML4LLM Ch.6 · proj35: [Raw and softmax attention scores](https://github.com/saurabhr/ML4LLM_book/blob/main/chapter_6/ml4llm_ch6_proj35_solution.ipynb) ([helper](https://github.com/saurabhr/ML4LLM_book/blob/main/chapter_6/ml4llm_ch6_proj35_helper.ipynb)).
