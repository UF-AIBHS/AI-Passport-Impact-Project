...
**Context:** Built on [Symptom2Disease](https://huggingface.co/datasets/gretelai/symptom_to_diagnosis) (Apache-2.0, Hugging Face) `input_text` patient messages describing symptoms — a standalone message is enough here since the analysis is per-message, not turn-to-turn (unlike Project 3, which needs the multi-turn MTS-Dialog set), anchored to ML4LLM Ch.6 · proj35: [Raw and softmax attention scores](https://github.com/saurabhr/ML4LLM_book/blob/main/chapter_6/ml4llm_ch6_proj35_solution.ipynb) ([helper](https://github.com/saurabhr/ML4LLM_book/blob/main/chapter_6/ml4llm_ch6_proj35_helper.ipynb)).
...
- [Attention is not Explanation](https://arxiv.org/abs/1902.10186) (Jain & Wallace, NAACL 2019): the foundational, and contested, result this project's core question tests on medical text, whether attention weights actually track the tokens that matter to a prediction.
