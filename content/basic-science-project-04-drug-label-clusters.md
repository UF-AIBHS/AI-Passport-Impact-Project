...
- [Multimodal Model with Text and Drug Embeddings for Adverse Drug Reaction Classification](https://arxiv.org/abs/2210.13238): combines drug-label text embeddings with structured drug representations to study shared risk patterns, the same embedding-space grouping question this project asks of DailyMed warning text.
