...
| [dair-ai/emotion](https://huggingface.co/datasets/dair-ai/emotion) | Foundations 3 | `datasets.load_dataset` (Hugging Face) | Open, no license restriction noted on the HF card; general-domain (not health-specific) emotion labels |
...
| [MedDialog / HealthCareMagic-100k](https://huggingface.co/datasets/lavita/ChatDoctor-HealthCareMagic-100k) | Basic Science 3, 7 | `datasets.load_dataset` (Hugging Face) | 100k+ real patient–doctor chat dialogues; open on Hugging Face |
...
| [PubMedQA](https://pubmedqa.github.io/) | Basic Science 6 | Free download | Yes/no/maybe biomedical QA over PubMed abstracts; open research dataset |
